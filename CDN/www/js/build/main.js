  ...
  function () {
    ...
    _createClass(mainHandlers, [{
      ...
      value: function createIframe() {
        ...
        window.onmessage = function (e) {
          if (e.data.test !== undefined) {
            ...
            _this.responsiveFunc(); // if (e.data.previous_input !== undefined || e.data.previous_input !== null) {
      ...
      value: function basicStylesSetUp() {
        ...
        css += ".iframe-cognitive-assistant-container.notification{ height: 200px; width: 220px;max-width: 365px;box-shadow: none;right: 0;bottom: 0; }";
