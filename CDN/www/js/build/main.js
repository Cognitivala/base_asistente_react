  ...
  function () {
    ...
    _createClass(mainHandlers, [{
      ...
      value: function basicStylesSetUp() {
        ...
        css += ".iframe-cognitive-assistant-container.notification{ height: 200px;width: 100%;max-width: 365px;box-shadow: none;right: 0;bottom: 0; }";
        css += ".iframe-cognitive-assistant-container.assistant{ height: 90vh;width: 100%;max-width: 401px;right: 0px;bottom: 0px; }";
