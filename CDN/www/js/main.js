(function (window, document) {
  ...
  class mainHandlers {
    ...
    basicStylesSetUp() {
      ...
      css +=
        "@media screen and (max-width: 767px){ .iframe-cognitive-assistant-container.assistant{ border-radius: 0px; height: 100%; width: 100%; top: 0; left: 0; right: 0; bottom: 0; max-width:100%; } ";
