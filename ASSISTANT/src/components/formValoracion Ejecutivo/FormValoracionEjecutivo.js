...
const FormValoracionEjecutivo = ({ generalStates, sendValoracion}) => {
    ...
    <div className='conversationBubbleForm Send'>
      ...
      <form autoComplete="off" onSubmit={enviarValoracion}>
        ...
        <div className="headerForm">
            <p>Gracias por utilizar nuestro chat. No dudes en dejarnos cualquier comentario adicional GRACIASSSSSS!!!!!.</p>
        </div>
...
export default FormValoracionEjecutivo;
