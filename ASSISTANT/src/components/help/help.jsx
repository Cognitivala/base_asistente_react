...
export default class Help extends Component {
      ...
      return (
        <div ref={this.help} className={css2 + mainCss.AssistantHelper}>
          ...
          <p className={mainCss.Subtittle}>
            Haz <strong>clic</strong> en los siguientes tópicos para <strong>obtener ayuda</strong> de cómo utilizar la asistencia online.
          </p>
          {ayudaStates.get('ayuda').map((map, i) => {
            return (
              <HelpBox
                ...
                generalStates={this.props.generalStates}
              />
            );
          })}
        </div>
  ...
  render() {
    ...
    return (
      <IsFetching isFetching={ayudaStates.get('isFetching')} showChildren={true} colorHeader={colorHeader} mainCss={mainCss}>
