      ...
      if (enabled !== undefined && enabled) {
        ...
        if (last) {
          ...
          if (like !== undefined && like) {
            ...
            retorno.push(
              <FormAsistencia key={`${j} * ${j} * 535`} asistencia={this.props.asistencia} getAsistencia={this.props.getAsistencia} generalStates={generalStates} sendValoracion={sendValoracion} />
            )
          }
          else if ( rating ) {
            const { sendValoracion, generalStates } = this.props;
