      ...
      if (enabled !== undefined && enabled) {
        ...
        if (last) {
          ...
          if (like !== undefined && like) {
            ...
            retorno.push(
              <FormAsistencia key={`${j} * ${j} * 535`} asistencia={this.props.asistencia} updateConversation={updateConversation} generalStates={generalStates} sendValoracion={sendValoracion} />
            )
          }
          else if ( rating ) {
            const { sendValoracion, generalStates } = this.props;
